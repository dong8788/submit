...
<body>
	<div style="width:1200px;margin-left:auto;margin-right:auto">
		...
		<div class="table-wrapper" style="margin-left:250px;margin-top:200px;margin-bottom:300px;overflow-x:auto;max-width:100% ">
			<h4>상품 수정</h4>
			<br><br>
			<form id="prodWriteForm" action="${pageContext.request.contextPath}/seller/prodModify" method="post" enctype="multipart/form-data">
			...
			<table style="width:100%;" border="1">
				...
				<tr>
					<td>제품명</td>
					<td><input type="text" name="prodName" id="prodName" value="${ prod.prodName }"></td>
				</tr>
				<tr>
				<tr>
   					<td>제품사진</td>
				...
				<tr>
					<td>제품정보</td>
					<td style="margin:0; padding:0;"><textarea name="prodInfo" id="smarteditor" rows="10" cols="100" style="width: 100%;height: 350px">${ prod.prodInfo }</textarea></td>
				</tr>
				<tr>
					<td>가격</td>
			...
			<button type="button" id="subButton">수정</button><button onclick="locaion.href='<c:url value="/seller/prodDelete/${prod.prodSeq}"/>'">삭제</button>
			</form>
		</div>
	</div>
</body>
