...
if(!nhn.husky){nhn.husky={}}(function(){
	...
	nhn.husky.HuskyCore=jindo.$Class({
		...
		$init:function(e){
			...
			if(this.htOptions.oDebugger){
				nhn.husky.HuskyCore.getCore=function(){return a};
			...
			exec:function(g,f,e){
				if(this.appStatus==nhn.husky.APP_STATUS.NOT_READY){
					this.messageQueue[this.messageQueue.length]={msg:g,args:f,event:e};
					return true
				}
				this.exec=this._exec;
				this.exec(g,f,e)},
				delayedExec:function(j,g,e,f){
					var h=jindo.$Fn(this.exec,this).bind(j,g,f);setTimeout(h,e)
				},
